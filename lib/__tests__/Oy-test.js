...
describe('Oy', function () {
  ...
  it('should raise warning on basic validation error', function () {
    ...
    expect(console.error).toHaveBeenCalledWith('Warning: Failed %s type: %s%s', 'prop', 'Relative links can break (i.e. if recipients are outside the company network) and make your content unavailable to view', jasmine.any(String));
  });
});